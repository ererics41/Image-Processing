...
im1Recon50 = reconstructDFT(im1Arr,0.5);
im1Recon20 = reconstructDFT(im1Arr,0.2);
im1Recon10 = reconstructDFT(im1Arr,0.1);
im1Recon5 = reconstructDFT(im1Arr,0.05);
im1Recon1 = reconstructDFT(im1Arr,0.01);
...
im2Recon50 = reconstructDFT(im2Arr,0.5);
im2Recon20 = reconstructDFT(im2Arr,0.2);
im2Recon10 = reconstructDFT(im2Arr,0.1);
im2Recon5 = reconstructDFT(im2Arr,0.05);
im2Recon1 = reconstructDFT(im2Arr,0.01);
%show image 1 and reconstructed images
figure(7);
imshow(im2Arr,[]);
figure(8);
